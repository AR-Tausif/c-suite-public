...
const SolutionContentBox: React.FC<SolutionContentBoxProps> = ({ item }) => {
  ...
  return (
    <div className="group transform  rounded-xl bg-white shadow-sm transition duration-300 hover:scale-105">
      <div className="relative overflow-hidden rounded-xl shadow-sm transition-all duration-300 hover:shadow-sm">
        <div className={`bg-gradient-to-br ${bg} p-8 lg:h-[25rem]`}>
