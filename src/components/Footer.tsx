        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pt-16 pb-8">
                ...
                <div className="animate__animated animate__fadeIn">
                    <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">ServicePro</h3>
                    <p className="text-gray-400 mb-6">Transforming businesses through innovative solutions and strategic excellence.</p>
                ...
                <div className="animate__animated animate__fadeIn" style={{animationDelay: "0.2s"}}>
                    ...
                    <ul className="space-y-3">
                        ...
                        <li><a href="#concept" className="text-gray-400 hover:text-white transition-colors">Concept</a></li>
                        ...
                        <li><a href="#experts" className="text-gray-400 hover:text-white transition-colors">Experts</a></li>
                    </ul>
                </div>
                ...
                <div className="animate__animated animate__fadeIn" style={{animationDelay: "0.4s"}}>
                    ...
                    <ul className="space-y-3">
                        ...
                        <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Business Strategy</a></li>
                        ...
                        <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Security Services</a></li>
                    </ul>
                </div>
            ...
            <div className="border-t border-gray-800 py-8 mt-8">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm">&copy; 2024 ServicePro. All rights reserved.</p>
